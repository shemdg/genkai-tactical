...
{{--            <p class="text-sm text-gray-400">Genkai Tactical</p>--}}
{{--        </div>--}}

{{--        <nav class="mt-6">--}}
{{--            <a href="{{ route('admin.dashboard') }}" class="flex items-center px-6 py-3 {{ request()->routeIs('admin.dashboard') ? 'bg-red-600' : 'hover:bg-gray-800' }}">--}}
{{--                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">--}}
...
{{--            <a href="{{ route('admin.products.index') }}" class="flex items-center px-6 py-3 {{ request()->routeIs('admin.products.*') ? 'bg-red-600' : 'hover:bg-gray-800' }}">--}}
{{--                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">--}}
...
{{--            <a href="{{ route('admin.orders.index') }}" class="flex items-center px-6 py-3 {{ request()->routeIs('admin.orders.*') ? 'bg-red-600' : 'hover:bg-gray-800' }}">--}}
{{--                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">--}}
